...
function goRight() {
    ...
    lead you away from the dragon all together. Which do you take? past the dragon or away from dragon`)
...
function follow(){
    let thirdAnswer = window.prompt(`You follow the cat to a colony of cats, snuggled in a fort of warm blankets and subsisting off of inexplicably warm soup. They are content with you staying. stay or spread the word`)
    if (thirdAnswer==="stay"){
...
function continueThrough(){
    let thirdAnswer = window.prompt('You come across a chamber that extends upward to a shining light above. There is a long, winding staircase and a much quicker, but rickety-looking, ladder that lead up towards the light. Which do you take? ladder or staircase')
